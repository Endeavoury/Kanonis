...
import { KanonisMaintenanceNotice } from './maintenance-notice.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-maintenance-notice',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    message: { control: 'text', description: 'Public property.' },
    until: { control: 'text', description: 'Public property.' },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `heading`, `message`, `until`. This component does not expose a slot. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-maintenance-notice') as HTMLElement &
