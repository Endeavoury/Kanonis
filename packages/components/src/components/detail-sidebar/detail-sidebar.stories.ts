...
import { KanonisDetailSidebar } from './detail-sidebar.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-detail-sidebar',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    modal: { control: 'boolean', description: 'Public property.' },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `open`, `modal`, `heading`, `closeLabel`. Slots: `summary`, `default`, `footer`. Events: `kanonis-close`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-detail-sidebar') as HTMLElement &
