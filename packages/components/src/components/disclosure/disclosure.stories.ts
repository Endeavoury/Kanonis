...
import { KanonisDisclosure } from './disclosure.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-disclosure',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    summary: { control: 'text', description: 'Public property.' },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `summary`, `open`, `disabled`. Slots: `summary`, `default`. Events: `kanonis-disclosure-change`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-disclosure') as HTMLElement &
    ...
    for (const eventName of ['kanonis-disclosure-change'] as readonly string[]) {
