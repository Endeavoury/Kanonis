...
const meta: Meta = {
  ...
  argTypes: {
    ...
    position: {
      ...
      description: "Public property ('left' | 'center' | 'right' | 'top' | 'bottom').",
    },
    collapsed: { control: 'boolean', description: 'Public property.' },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `position`, `collapsed`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-pane') as HTMLElement &
