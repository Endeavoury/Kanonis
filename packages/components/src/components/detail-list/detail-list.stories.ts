...
const meta: Meta = {
  title: 'Components/kanonis-detail-list',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    items: { control: 'object', description: 'Public property (KanonisDetailItem[]).' },
  },
  parameters: {
    docs: {
      description: {
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-detail-list') as HTMLElement &
