...
import { KanonisToastRegion } from './toast-region.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-toast-region',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    position: {
      ...
      description: "Public property ('top-end' | 'top-start' | 'bottom-end' | 'bottom-start').",
    },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `position`, `label`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-toast-region') as HTMLElement &
