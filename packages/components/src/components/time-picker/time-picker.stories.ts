...
import { KanonisTimePicker } from './time-picker.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-time-picker',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'This component has no public properties. This component does not expose a slot. Events: `kanonis-change`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-time-picker') as HTMLElement &
