...
const meta: Meta = {
  title: 'Components/kanonis-compare-view',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    leftLabel: { control: 'text', description: 'Public property.' },
    rightLabel: { control: 'text', description: 'Public property.' },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `leftLabel`, `rightLabel`. Slots: `left`, `right`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-compare-view') as HTMLElement &
