...
const meta: Meta = {
  title: 'Components/kanonis-icon-button',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `size`, `disabled`, `label`, `type`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-icon-button') as HTMLElement &
