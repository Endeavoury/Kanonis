...
const meta: Meta = {
  title: 'Components/kanonis-role-badge',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    tone: {
      control: 'select',
      options: ['neutral', 'admin', 'danger'],
      description: "Public property ('neutral' | 'admin' | 'danger').",
    },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `label`, `tone`. This component does not expose a slot. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-role-badge') as HTMLElement &
