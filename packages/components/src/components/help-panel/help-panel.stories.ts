...
import { KanonisHelpPanel } from './help-panel.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-help-panel',
  tags: ['autodocs'],
  args: {
    slotContent: 'Example content',
    heading: 'Need help?',
    description: 'Find answers and guidance for this workspace.',
  },
  argTypes: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `heading`, `description`. Slots: `links`, `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-help-panel') as HTMLElement &
