...
import { KanonisIcon } from './icon.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-icon',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    name: {
      ...
      description: 'Public property (KanonisIconName).',
    },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `name`, `label`. This component does not expose a slot. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-icon') as HTMLElement &
