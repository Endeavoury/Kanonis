...
import { KanonisSidebar } from './sidebar.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-sidebar',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `label`, `collapsed`. Slots: `brand`, `default`, `footer`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-sidebar') as HTMLElement &
