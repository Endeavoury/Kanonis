...
import { KanonisPaneContent } from './pane-content.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-pane-content',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    scrollable: { control: 'boolean', description: 'Public property.' },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `scrollable`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-pane-content') as HTMLElement &
