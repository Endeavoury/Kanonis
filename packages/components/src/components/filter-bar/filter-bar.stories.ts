...
const meta: Meta = {
  title: 'Components/kanonis-filter-bar',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `columns`. Slots: `default`, `actions`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-filter-bar') as HTMLElement &
