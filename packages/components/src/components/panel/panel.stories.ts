...
import { KanonisPanel } from './panel.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-panel',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    eyebrow: { control: 'text', description: 'Public property.' },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `heading`, `eyebrow`, `description`. Slots: `header`, `actions`, `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-panel') as HTMLElement &
