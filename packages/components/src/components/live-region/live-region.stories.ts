...
const meta: Meta = {
  title: 'Components/kanonis-live-region',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    politeness: {
      ...
      description: "Public property ('polite' | 'assertive').",
    },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `message`, `politeness`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-live-region') as HTMLElement &
