...
import { KanonisStepper } from './stepper.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-stepper',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    steps: { control: 'object', description: 'Public property (KanonisStep[]).' },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `steps`, `value`. This component does not expose a slot. Events: `kanonis-step-change`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-stepper') as HTMLElement &
    ...
    for (const eventName of ['kanonis-step-change'] as readonly string[]) {
