...
import { KanonisMenuItem } from './menu-item.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-menu-item',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    tone: {
      ...
      description: "Public property ('default' | 'danger').",
    },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `value`, `disabled`, `tone`. Slots: `icon`, `default`. Events: `kanonis-menu-select`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-menu-item') as HTMLElement &
    ...
    for (const eventName of ['kanonis-menu-select'] as readonly string[]) {
