...
import { KanonisPaneStack } from './pane-stack.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-pane-stack',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    split: {
      ...
      description: "Public property ('50/50' | '40/60' | '60/40' | '30/70' | '70/30').",
    },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `split`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-pane-stack') as HTMLElement &
