...
const meta: Meta = {
  title: 'Components/kanonis-empty-state',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `heading`, `description`. Slots: `icon`, `actions`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-empty-state') as HTMLElement &
