...
const meta: Meta = {
  title: 'Components/kanonis-stack',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    align: {
      ...
      description: "Public property ('start' | 'center' | 'end' | 'stretch').",
    },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `gap`, `align`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-stack') as HTMLElement &
