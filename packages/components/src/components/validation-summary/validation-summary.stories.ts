...
const meta: Meta = {
  title: 'Components/kanonis-validation-summary',
  tags: ['autodocs'],
  args: {
    slotContent: 'Example content',
    errors: [],
    heading: 'Please correct these errors',
  },
  argTypes: {
    slotContent: { control: 'text', description: 'Default-slot content.' },
    errors: { control: 'object', description: 'Public property (KanonisValidationError[]).' },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `errors`, `heading`. This component does not expose a slot. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-validation-summary') as HTMLElement &
