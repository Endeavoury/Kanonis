...
import { KanonisKpiGrid } from './kpi-grid.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-kpi-grid',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `columns`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-kpi-grid') as HTMLElement &
