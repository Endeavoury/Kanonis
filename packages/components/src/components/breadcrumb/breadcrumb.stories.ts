...
import { KanonisBreadcrumb } from './breadcrumb.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-breadcrumb',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    current: { control: 'boolean', description: 'Public property.' },
    disabled: { control: 'boolean', description: 'Public property.' },
    separator: { control: 'text', description: 'Public property.' },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `href`, `current`, `disabled`, `separator`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-breadcrumb') as HTMLElement &
