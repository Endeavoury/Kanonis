...
import { KanonisFileUpload } from './file-upload.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-file-upload',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'This component has no public properties. This component does not expose a slot. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-file-upload') as HTMLElement &
