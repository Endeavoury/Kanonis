...
import { KanonisJsonEditor } from './json-editor.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-json-editor',
  tags: ['autodocs'],
  args: {
    slotContent: 'Example content',
    invalidMessage: 'Example',
  },
  argTypes: {
    slotContent: { control: 'text', description: 'Default-slot content.' },
    invalidMessage: { control: 'text', description: 'Public property.' },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `invalidMessage`. This component does not expose a slot. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-json-editor') as HTMLElement &
