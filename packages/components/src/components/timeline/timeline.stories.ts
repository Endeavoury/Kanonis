...
const meta: Meta = {
  title: 'Components/kanonis-timeline',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    items: { control: 'object', description: 'Public property (KanonisTimelineItem[]).' },
  },
  parameters: {
    docs: {
      description: {
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-timeline') as HTMLElement &
