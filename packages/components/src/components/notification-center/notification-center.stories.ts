...
const meta: Meta = {
  title: 'Components/kanonis-notification-center',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    notifications: { control: 'object', description: 'Public property (KanonisNotification[]).' },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `notifications`, `open`, `label`. This component does not expose a slot. Events: `kanonis-notification-read`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-notification-center') as HTMLElement &
    ...
    for (const eventName of ['kanonis-notification-read'] as readonly string[]) {
