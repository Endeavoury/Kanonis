...
import { KanonisContextMenu } from './context-menu.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-context-menu',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `label`, `open`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-context-menu') as HTMLElement &
