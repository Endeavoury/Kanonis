...
const meta: Meta = {
  title: 'Components/kanonis-workspace',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'This component has no public properties. Slots: `header`, `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-workspace') as HTMLElement &
