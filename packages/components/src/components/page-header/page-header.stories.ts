...
const meta: Meta = {
  title: 'Components/kanonis-page-header',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `eyebrow`, `heading`, `description`. Slots: `actions`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-page-header') as HTMLElement &
