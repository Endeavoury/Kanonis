...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Properties: `value`, `label`. Slots: `default`. Events: `kanonis-tab-change`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-tabs') as HTMLElement &
    ...
    for (const eventName of ['kanonis-tab-change'] as readonly string[]) {
