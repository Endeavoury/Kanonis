...
import { KanonisSplitButton } from './split-button.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-split-button',
  tags: ['autodocs'],
  args: {
    slotContent: 'Example content',
    label: 'Run',
    menuLabel: 'Related actions',
    open: false,
    disabled: false,
  },
  argTypes: {
    ...
    menuLabel: { control: 'text', description: 'Public property.' },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `label`, `menuLabel`, `open`, `disabled`. Slots: `default`, `menu`. Events: `kanonis-activate`, `kanonis-menu-toggle`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-split-button') as HTMLElement &
    ...
    for (const eventName of ['kanonis-activate', 'kanonis-menu-toggle'] as readonly string[]) {
