...
import { KanonisList } from './list.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-list',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    divided: { control: 'boolean', description: 'Public property.' },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `label`, `divided`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-list') as HTMLElement &
