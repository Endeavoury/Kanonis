...
import { KanonisInline } from './inline.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-inline',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    align: {
      ...
      description: "Public property ('start' | 'center' | 'end').",
    },
    justify: {
      control: 'select',
      options: ['start', 'center', 'end', 'between'],
      description: "Public property ('start' | 'center' | 'end' | 'between').",
    },
    wrap: { control: 'boolean', description: 'Public property.' },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `gap`, `align`, `justify`, `wrap`, `collapseAtCompact`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-inline') as HTMLElement &
