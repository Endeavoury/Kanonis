...
const meta: Meta = {
  title: 'Components/kanonis-radio-group',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `label`, `name`, `value`, `required`, `disabled`, `helpText`, `error`. Slots: `default`. Events: `kanonis-change`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-radio-group') as HTMLElement &
