...
const meta: Meta = {
  title: 'Components/kanonis-banner',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `heading`, `dismissible`. Slots: `default`. Events: `kanonis-dismiss`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-banner') as HTMLElement &
