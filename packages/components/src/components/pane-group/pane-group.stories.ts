...
import { KanonisPaneGroup } from './pane-group.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-pane-group',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    orientation: {
      ...
      description: "Public property ('horizontal' | 'vertical').",
    },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `orientation`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-pane-group') as HTMLElement &
