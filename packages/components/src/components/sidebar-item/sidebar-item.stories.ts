...
import { KanonisSidebarItem } from './sidebar-item.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-sidebar-item',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `value`, `href`, `active`, `disabled`. Slots: `icon`, `default`. Events: `kanonis-activate`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-sidebar-item') as HTMLElement &
    ...
    for (const eventName of ['kanonis-activate'] as readonly string[]) {
