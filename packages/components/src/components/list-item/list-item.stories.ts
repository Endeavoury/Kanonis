...
const meta: Meta = {
  title: 'Components/kanonis-list-item',
  tags: ['autodocs'],
  args: {
    slotContent: 'Example content',
    value: 'Example value',
    href: '',
    supportingText: 'Example',
    selected: false,
    disabled: false,
  },
  argTypes: {
    ...
    supportingText: { control: 'text', description: 'Public property.' },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `value`, `href`, `supportingText`, `selected`, `disabled`. Slots: `leading`, `default`, `trailing`. Events: `kanonis-list-activate`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-list-item') as HTMLElement &
    ...
    for (const eventName of ['kanonis-list-activate'] as readonly string[]) {
