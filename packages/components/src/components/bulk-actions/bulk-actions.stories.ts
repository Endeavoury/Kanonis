...
import { KanonisBulkActions } from './bulk-actions.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-bulk-actions',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    count: { control: { type: 'number' }, description: 'Public property.' },
    selectedLabel: { control: 'text', description: 'Public property.' },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `count`, `selectedLabel`, `clearLabel`. Slots: `default`. Events: `kanonis-clear-selection`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-bulk-actions') as HTMLElement &
    ...
    for (const eventName of ['kanonis-clear-selection'] as readonly string[]) {
