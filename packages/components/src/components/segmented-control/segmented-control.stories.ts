...
import { KanonisSegmentedControl } from './segmented-control.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-segmented-control',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Properties: `value`, `label`. Slots: `default`. Events: `kanonis-change`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-segmented-control') as HTMLElement &
