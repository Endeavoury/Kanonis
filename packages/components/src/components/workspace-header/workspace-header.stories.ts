...
import { KanonisWorkspaceHeader } from './workspace-header.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-workspace-header',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `heading`. Slots: `breadcrumb`, `title`, `status`, `actions`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-workspace-header') as HTMLElement &
