...
const meta: Meta = {
  title: 'Components/kanonis-approval-flow',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    status: {
      ...
      description: "Public property ('draft' | 'pending' | 'approved' | 'rejected').",
    },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `status`. This component does not expose a slot. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-approval-flow') as HTMLElement &
