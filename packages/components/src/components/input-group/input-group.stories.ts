...
const meta: Meta = {
  title: 'Components/kanonis-input-group',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `label`. Slots: `prefix`, `default`, `suffix`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-input-group') as HTMLElement &
