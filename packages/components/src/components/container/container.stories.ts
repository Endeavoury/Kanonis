...
import { KanonisContainer } from './container.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-container',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    size: {
      ...
      description: "Public property ('narrow' | 'normal' | 'wide').",
    },
    flush: { control: 'boolean', description: 'Public property.' },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `size`, `flush`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-container') as HTMLElement &
