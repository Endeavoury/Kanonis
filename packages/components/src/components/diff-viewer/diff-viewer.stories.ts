...
import { KanonisDiffViewer } from './diff-viewer.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-diff-viewer',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    lines: { control: 'object', description: 'Public property (KanonisDiffLine[]).' },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `lines`. This component does not expose a slot. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-diff-viewer') as HTMLElement &
