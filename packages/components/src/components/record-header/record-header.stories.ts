...
import { KanonisRecordHeader } from './record-header.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-record-header',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    status: { control: 'text', description: 'Public property.' },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `heading`, `description`, `status`. Slots: `meta`, `actions`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-record-header') as HTMLElement &
