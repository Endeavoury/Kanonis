...
const meta: Meta = {
  title: 'Components/kanonis-field-array',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    items: { control: 'object', description: 'Public property (KanonisFieldItem[]).' },
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `items`, `label`, `addLabel`. This component does not expose a slot. Events: `kanonis-items-change`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-field-array') as HTMLElement &
    ...
    for (const eventName of ['kanonis-items-change'] as readonly string[]) {
