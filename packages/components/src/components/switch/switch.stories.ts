...
const meta: Meta = {
  title: 'Components/kanonis-switch',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `name`, `value`, `checked`, `disabled`, `required`, `helpText`. Slots: `default`. Events: `kanonis-change`.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-switch') as HTMLElement &
