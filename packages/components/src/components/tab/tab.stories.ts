...
import { KanonisTab } from './tab.js';
import '@endeavoury/kanonis';

const meta: Meta = {
  title: 'Components/kanonis-tab',
  tags: ['autodocs'],
  args: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `value`, `label`, `disabled`, `active`. Slots: `default`. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-tab') as HTMLElement &
