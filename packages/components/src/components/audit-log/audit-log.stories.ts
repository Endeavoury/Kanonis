...
const meta: Meta = {
  title: 'Components/kanonis-audit-log',
  tags: ['autodocs'],
  args: {
  ...
  argTypes: {
    ...
    entries: { control: 'object', description: 'Public property (KanonisAuditEntry[]).' },
  },
  parameters: {
    docs: {
      description: {
        component:
          'Properties: `entries`. This component does not expose a slot. This component does not emit a custom event.',
      },
    },
  },
};
...
export const Usage: Story = {
  render: (args) => {
    ...
    const component = document.createElement('kanonis-audit-log') as HTMLElement &
